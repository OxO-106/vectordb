...
def main():
    ...
    # Set dimensions to analyze (16, 32, 48, ..., up to 512)
    # Still include dimension 1 for baseline comparison
    dimensions = [1] + list(range(16, 513, 16))
    ...
    precision_df.to_csv(os.path.join("precision16.csv"), index=False)

    print("\nAnalysis complete!")
    print(f"Precision results saved to: {os.path.join('precision16.csv')}")
    print(f"Total dimensions analyzed: {len(dimensions)}")
